...
> {
    ...
    if (this.state.edit_mode)
      return (
        <tr>
          ...
          <td>
            <button onClick={this.handleSave} id={this.props.asset._id}>
              save
            </button>
  ...
  handleNameChange(event: any) {
    ...
    axios
      .post("http://localhost:8080/assets/update/" + newAsset._id, newAsset)
  ...
  handleDelete() {
    axios
      .get("http://localhost:8080/assets/delete/" + this.props.asset._id)
      .then(res => console.log(res.data));
    const action: IAssetAction = {
